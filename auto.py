...
def Get_pics():
    initial_path='/home/jmarkz08/Downloads'
    ...
    for x in range(0, len (path_pics_list)):
        image_list[x] =  ImageTk.PhotoImage((Image.open(path_pics + '/' + path_pics_list[x])).resize((520,270), Image.Resampling.LANCZOS) )
...
my_label = Label(bg="gray" , borderwidth=2, relief="groove", height = 15)
my_label.grid(row=0, rowspan = 8, column=0, columnspan=3, sticky = "nesw")
